...
export default class App extends Component {
  ...
  render() {
    return (
      <View style={{backgroundColor:'aqua',justifyContent:'left', 
    alignItems:'center', paddingBottom:90, paddingTop:5}}>
        <View>
          <TouchableOpacity
            style={{
              width: 150,height: 80,justifyContent: 'center',alignItems: 'center',
borderRadius: 100,backgroundColor: 'red',borderWidth: 2,borderColor: 'white',marginTop:5
            }}
            onPress={() => {
              var url =
        ...
        <View>
          <TouchableOpacity
            style={{
              width: 150,height: 80,justifyContent: 'center',alignItems: 'center',
borderRadius: 100,backgroundColor: 'green',borderWidth: 2,borderColor: 'white',marginTop:5
            }}
            onPress={() => {
              var url =
        ...
        <View>
          <TouchableOpacity
            style={{
             width: 150,height: 80,justifyContent: 'center',alignItems: 'center',
borderRadius: 100,backgroundColor: 'pink',borderWidth: 2,borderColor: 'white',marginTop:5
            }}
            onPress={() => {
              var url =
        ...
        <View>
          <TouchableOpacity
            style={{
              width: 150,height: 80,justifyContent: 'center',alignItems: 'center',
borderRadius: 100,backgroundColor: 'yellow',borderWidth: 2,borderColor: 'white',marginTop:5
            }}
            onPress={() => {
              var url =
...
borderRadius: 100,backgroundColor: 'purple',borderWidth: 2,borderColor: 'white',marginTop:5
          }}
          onPress={() => {
